...
1. **\*\*Total Sales by Fat Content:**
   	Objective: Analyze the impact of the content with total sales,
   	Chat Type: Donut Chart
2. **\*\*Total Sales by Item Type:**
   	Objective: Identify the performance of different item types in terms of total sales,
   	Chart Type: Bar Chart
3. **\*\*Fat Content by Outlet for Total Sales:**
   	Objective: Compare Total sales across different outlets segmented by far content.
...
**7. \*\*All Metrics by Outlet Type\*\*:**
	  Objective: Provide a comprehensive view of all key metrics\[TS, AS, No. Of Items, Avg. Rating] broken down by different outlet types.
	  Chart Type: Matrix

**\*\Author**\*\:**Ravirajan.V**
**\*\*Linkedin Profile\*\*:** (https://www.linkedin.com/in/ravirajan-v-67a07b174/)
